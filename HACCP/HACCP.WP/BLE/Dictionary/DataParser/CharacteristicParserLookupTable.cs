...
using HACCP.WP.BLE.Dictionary.DataParser.BLE_Specification;
using DayOfWeek = HACCP.WP.BLE.Dictionary.DataParser.BLE_Specification.DayOfWeek;
using TIUuids = HACCP.WP.BLE.Extras.TI_BLESensorTagGattUuids.TISensorTagCharacteristicUUIDs;
using TIParsers = HACCP.WP.BLE.Extras.TI_BLESensorTagCharacteristicParsers;

namespace HACCP.WP.BLE.Dictionary.DataParser
{
