...
namespace HACCP.WP.BLE.Dictionary
{
    ...
    public class CharacteristicDictionaryEntry
    {
        ...
        public void Initialize(Guid uuid, string name = CHARACTERISTIC_MISSING_STRING, bool isDefault = false)
        {
            ...
            var parserLookupTable = GlobalSettings.ParserLookupTable;
            ...
            get
            {
                switch ((uint) ReadUnknownAs)
                {
                    ...
                    case (uint) ReadUnknownAsEnum.NOT_UNKNOWN:
                        return "SOME KNOWN TYPE";
                            // UI will end up showing this as collapsed, but will still access the string. 
                    default:
        ...
        private Func<IBuffer, string> ParseBuffer
        {
            get
            {
                ...
                switch ((uint) ReadUnknownAs)
                {
                    ...
                    case (uint) ReadUnknownAsEnum.UTF8:
                        return BasicParsers.ParseUtf8;
                    case (uint) ReadUnknownAsEnum.NOT_UNKNOWN:
